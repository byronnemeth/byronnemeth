...
export default function Bio() {
  ...
  const bodyText = { fontSize: "18px", lineHeight: 1.9, color: "rgba(255,255,255,0.55)", fontWeight: 300, fontFamily: font };
  ...
  return (
    <main style={{ backgroundColor: "#080808", color: "#ffffff", minHeight: "100vh", fontFamily: font }}>
      ...
      <style>{`
        ...
        .bio-timeline-label { font-size: 11px; letter-spacing: 0.2em; text-transform: uppercase; color: rgba(255,255,255,0.3); margin-top: 8px; font-weight: 400; line-height: 1.5; }
        ...
        .bio-press-link { display: flex; justify-content: space-between; align-items: center; padding: 24px 32px; border: 1px solid rgba(255,255,255,0.08); text-decoration: none; color: rgba(255,255,255,0.6); font-size: 16px; font-weight: 300; }
        ...
        @media (max-width: 768px) {
          ...
          .bio-press-link { font-size: 14px; padding: 18px 20px; flex-direction: column; align-items: flex-start; gap: 8px; }
      ...
      <section className="bio-section">
        <div className="bio-container">
          ...
          <p style={{ ...bodyText, fontSize: "19px", marginBottom: "32px" }}>
          ...
          <p style={{ ...bodyText, marginBottom: "64px" }}>
          ...
          <div className="bio-timeline-row">
            <div>
              <p className="bio-timeline-year">EP</p>
              <p className="bio-timeline-label">Byron Nemeth Group</p>
            </div>
            <p style={bodyText}>
          ...
          <div className="bio-timeline-row">
            <div>
              <p className="bio-timeline-year">2000</p>
              <p className="bio-timeline-label">• Album</p>
            </div>
            <p style={bodyText}>
          ...
          <div className="bio-timeline-row">
            <div>
              <p className="bio-timeline-year">100 Worlds</p>
              <p className="bio-timeline-label">• Album</p>
            </div>
            <p style={bodyText}>
          ...
          <div className="bio-timeline-row">
            <div>
              <p className="bio-timeline-year">The Force Within</p>
              <p className="bio-timeline-label">• Album</p>
            </div>
            <p style={bodyText}>
          ...
          <div className="bio-timeline-row">
            <div>
              <p className="bio-timeline-year">The Video Chronicles</p>
              <p className="bio-timeline-label">• EP Video Album</p>
            </div>
            <p style={bodyText}>
          ...
          <div className="bio-timeline-row">
            <div>
              <p className="bio-timeline-year">2016 Tour</p>
              <p className="bio-timeline-label">• On The Road</p>
            </div>
            <p style={bodyText}>
          ...
          <div className="bio-timeline-row">
            <div>
              <p className="bio-timeline-year">2018 EP</p>
              <p className="bio-timeline-label">• Rogue Society</p>
            </div>
            <p style={bodyText}>
          ...
          <div className="bio-timeline-row">
            <div>
              <p className="bio-timeline-year">2019 Tour</p>
              <p className="bio-timeline-label">• On The Road</p>
            </div>
            <p style={bodyText}>
          ...
          <div className="bio-timeline-row">
            ...
            <div style={{ display: "flex", flexDirection: "column", gap: "20px" }}>
              <p style={bodyText}>In 2023 a new version of <strong style={{ color: "rgba(255,255,255,0.8)", fontWeight: 500 }}>Byron Nemeth Group</strong> is set to be unleashed on to the music world with Las Vegas being the city where the first show happens. The new single Spanish Transcendence is now live on all streaming platforms and this website.</p>
              <p style={bodyText}>The Guitar Academy education platform launched in May of 2023 as a comprehensive private lessons platform for teaching guitar students exactly what they want to learn with detailed musical concepts tailored to the individuals needs.</p>
              <p style={bodyText}><strong style={{ color: "rgba(255,255,255,0.8)", fontWeight: 500 }}>Byron Nemeth Group</strong> lineup is revealed — Byron Nemeth | Guitar • Riley Baxter | Vocals • Dennis Osinski | Drums • Paul Hughes | Bass Guitar with concerts announced at the OYO Casino | Vegas Stand Up &amp; Rock and Backstage Bar and Billiards on Fremont Street with Hookers &amp; Blow for their 20th Anniversary show celebration.</p>
              <p style={bodyText}><strong style={{ color: "rgba(255,255,255,0.8)", fontWeight: 500 }}>Byron Nemeth Group</strong> will enter the recording studio on Monday October 23rd with Producer Vinnie Castaldo at The Tone Factory to record the uptempo rocker "Hell 2 Pay" and soaring ballad "It's All Over". Performance video to shoot on Sunday December 3rd in Las Vegas.</p>
              <div>
                <p className="bio-sub-label">• Hell To Pay</p>
                <p style={bodyText}><a href="https://www.youtube.com/watch?v=KbzvGpEjM8k" target="_blank" rel="noopener noreferrer" style={link}><strong style={{ color: "#f59e0b" }}>Hell To Pay</strong> Video Released 12.25.23</a> &nbsp;•&nbsp; View on YouTube <a href="https://www.youtube.com/watch?v=KbzvGpEjM8k" target="_blank" rel="noopener noreferrer" style={link}>HERE</a></p>
                <p style={{ ...bodyText, marginTop: "12px" }}>Audio recorded by Johnny Gibson at the <a href="https://www.thetonefactory.com/" target="_blank" rel="noopener noreferrer" style={link}>Tone Factory</a> on 10.23.23. Audio mixed and produced by Dylan Dyce on 10.30.23. Music Video filmed and edited by Alyssa Gibson. Video shot on location at The <a href="https://www.jackpotbarlv.com/" target="_blank" rel="noopener noreferrer" style={link}>Jackpot</a> in Las Vegas &amp; Tone Factory 12.04.23.</p>
              </div>
            </div>
          </div>
          ...
          <div className="bio-timeline-row">
            ...
            <div style={{ display: "flex", flexDirection: "column", gap: "20px" }}>
              <p style={bodyText}><strong style={{ color: "rgba(255,255,255,0.8)", fontWeight: 500 }}>The Zen Of Guitar • Understanding Guitar Thru Direct Intuition Volume Three</strong> is released on February 14th, 2025. Purchase on Amazon <a href="https://www.amazon.com/Guitar-Understanding-Direct-Intuition-Three-ebook/dp/B0DTT3LTY4?ref_=ast_author_dp" target="_blank" rel="noopener noreferrer" style={link}>HERE.</a></p>
              <p style={bodyText}>The Byron Nemeth Group proudly welcomes stellar vocalist <a href="https://www.instagram.com/everyguitarever/" target="_blank" rel="noopener noreferrer" style={link}><strong style={{ color: "#f59e0b" }}>Peter Barcott</strong></a> to the lineup, igniting a powerful new era of Hard Rock and Metal. Known for his commanding voice and electrifying stage presence, Barcott brings a fresh surge of energy to the band, taking the lead on vocals and co-composing a wave of original material that promises to hit with both ferocity and finesse.</p>
              <div>
                <p className="bio-sub-label">• I Am Thee Ocean</p>
                <p style={{ ...bodyText, marginBottom: "16px" }}><strong style={{ color: "rgba(255,255,255,0.8)", fontWeight: 500 }}>I Am Thee Ocean • Released on 10.31.25</strong></p>
                <p style={{ ...bodyText, marginBottom: "16px" }}>This release marks a significant artistic milestone for the Byron Nemeth Group: <em>"I Am The Ocean"</em> now available on all streaming platforms, is much more than a new track — it is a bold statement of collective musical identity and creative evolution.</p>
                <p style={{ ...bodyText, marginBottom: "16px" }}>Complementing that guitar framework is the distinctive vocal delivery of <a href="https://www.instagram.com/everyguitarever/" target="_blank" rel="noopener noreferrer" style={link}>Peter Barcott</a>, whose voice brings the lyrics to life with gritty confidence and evocative nuance. On drums, Dennis Osinski delivers a performance that anchors the track with unshakeable drive. Meanwhile, Paul Hughes on bass guitar lays the harmonic foundation, his low-end lines weaving seamlessly with guitar and drums.</p>
                <p style={bodyText}><em>"I Am The Ocean"</em> stands as a testament to what the Byron Nemeth Group can achieve when each member brings their absolute best. We invite you to listen, to dive in, and to experience how Byron Nemeth, Peter Barcott, Dennis Osinski and Paul Hughes have together created something truly memorable.</p>
              </div>
            </div>
          </div>
          ...
          <div className="bio-timeline-row">
            <div>
              <p className="bio-timeline-year">2026</p>
              <p className="bio-timeline-label">• NAMM Show</p>
            </div>
            <p style={bodyText}>Byron Nemeth Group delivered a successful and acclaimed performance at the 2026 NAMM Show in Anaheim, California — one of the most prestigious music industry events in the world. The performance showcased the band's powerful live presence and highlighted Byron's dual identity as a world-class guitarist and forward-thinking AI technology entrepreneur. The NAMM appearance reinforced Byron's standing as a multi-dimensional creative force — a musician whose artistry is matched by his vision for the future of technology and music.</p>
          </div>
          ...
          <div style={{ textAlign: "center", marginBottom: "32px" }}>
            <p style={{ fontSize: "15px", color: "rgba(255,255,255,0.3)", fontFamily: font, fontWeight: 300 }}>
